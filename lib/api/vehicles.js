...
vehicles.list = function(req, res) {
  var p = req.params, a = p.agency, r = p.route ? p.route : '',
      path = [NBXML_FEED, '?command=vehicleLocations&a=', req.params.agency, '&r=', r, '&t=0'].join('');
...
vehicles.get = function(req, res) {
  var p = req.params, a = p.agency, v = p.vehicle,
